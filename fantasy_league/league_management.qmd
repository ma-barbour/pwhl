...
for(i in 1:length(game_ids)) {
        ...
        goals_data <- tibble(first_name = loop_data$scoredBy$firstName,
                            ...
                            id = loop_data$scoredBy$id)
        
        goals_data <- goals_data |>
                mutate(player = paste(first_name, last_name, id),
                       goal = 1) |>
                select(player, goal) 
...
the_whole_thing <- league_roster_data |>
        left_join(league_scoring_data, join_by(player, week_number))
